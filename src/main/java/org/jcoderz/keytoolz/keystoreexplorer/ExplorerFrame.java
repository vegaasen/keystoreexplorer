...
public class ExplorerFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon(FileUtils.getResourceByClassPath("/images/keystore.gif"))
                .getImage());
        ...
        jButton1.setIcon(new ImageIcon(FileUtils.getResourceByClassPath("/images/openfolder.gif"))); // NOI18N
    ...
    private void jTree1VetoableChange(PropertyChangeEvent evt)
    ...
    private void treeExpanded(TreeExpansionEvent evt) {
        jTree1.revalidate();
    }// GEN-LAST:event_treeExpanded


    // GEN-FIRST:event_treeWillExpand
    private void treeWillExpand(TreeExpansionEvent evt)
            throws javax.swing.tree.ExpandVetoException {
